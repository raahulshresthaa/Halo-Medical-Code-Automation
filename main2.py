...
auto_doc_ref_entry = ttk.Entry(info_frame, width=30, style='My.TEntry')
clinic_label = ttk.Label(info_frame, text='Clinic:', style='My.TLabel')
clinic_entry = ttk.Entry(info_frame, width=30, style='My.TEntry')
datetime_label = ttk.Label(info_frame, text='Date and Time:', style='My.TLabel')
datetime_entry = ttk.Entry(info_frame, width=30, style='My.TEntry')
