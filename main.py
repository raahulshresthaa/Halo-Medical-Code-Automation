...
def create_search_tab(notebook):
    ...
    # 7) Define a refresh function to be called after theme changes
    def refresh_chart():
    ...
    # 8) Store the refresh function in a global so change_theme can call it
    global analysis_refresh_chart
    analysis_refresh_chart = refresh_chart

    # 9) An optional "Refresh" button
